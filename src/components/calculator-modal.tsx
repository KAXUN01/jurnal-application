...
const FOREX_PAIRS: ForexPair[] = [
    ...
    { symbol: "NASDAQ", label: "NASDAQ", journalKey: "NASDAQ", pipStep: 1, pipValuePerLot: 1, isJpy: false },
    { symbol: "US500", label: "US500", journalKey: "US500", pipStep: 1, pipValuePerLot: 1, isJpy: false },
    { symbol: "UK100", label: "UK100", journalKey: "UK100", pipStep: 1, pipValuePerLot: 1, isJpy: false },
];
