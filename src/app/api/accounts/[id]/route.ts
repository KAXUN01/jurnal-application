    ...
    try {
        ...
        const updated = await prisma.account.update({
            ...
            data: {
                ...
                status: body.status,
                suspendedDate: body.status === "suspended" ? body.suspendedDate || new Date().toISOString().slice(0, 10) : null,
                suspendedReason: body.status === "suspended" ? body.suspendedReason || null : null,
